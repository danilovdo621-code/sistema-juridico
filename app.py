...
if not st.session_state['logged_in']:
    ...
    st.markdown("""
        ...
        /* Limpa espaçamentos padrões do Streamlit */
        ...
        .login-container {
            margin-top: 20vh; /* Centraliza verticalmente no desktop */
            padding: 40px;
        }
        ...
        @media only screen and (max-width: 768px) {
            .split-bg {
                /* No celular, a imagem vira um fundo total com transparência */
                width: 100%;
                height: 100vh;
                opacity: 0.1; /* Bem suave para não atrapalhar a leitura */
                z-index: -1;
            }
            .login-container {
                margin-top: 10vh; /* Sobe um pouco no celular */
                padding: 20px;
            ...
            /* Força o título a ficar menor no celular */
    ...
    # Layout responsivo via colunas
    # No desktop: Coluna 1 (6) é a imagem, Coluna 2 (4) é o login
    # No mobile: O Streamlit empilha. O CSS acima vai tratar o visual.
    c1, c2 = st.columns([6, 4])

    with c2:
        # Container para agrupar o login e aplicar o CSS .login-container
        with st.container():
            st.markdown('<div class="login-container">', unsafe_allow_html=True)

            st.markdown("<h1 style='text-align: center; color: #1e3a8a; font-family: Inter; margin-bottom: 0;'>⚖️ Jurídico Pro</h1>", unsafe_allow_html=True)
            st.markdown("<p style='text-align: center; color: #64748b; margin-bottom: 30px; font-size: 14px;'>Acesso Restrito ao Cliente</p>", unsafe_allow_html=True)
            ...
            st.markdown("<p style='text-align: center; font-size: 11px; color: #94a3b8; margin-top: 30px;'>Ambiente Seguro • Criptografia SSL</p>", unsafe_allow_html=True)
