...
if not st.session_state['logged_in']:
    ...
    st.markdown("""
        ...
        /* --- DESKTOP --- */
        .split-bg {
            position: fixed; top: 0; left: 0; width: 65%; height: 100vh;
            background-image: url('https://i.postimg.cc/50dwcw8Z/close-up-law-statue.jpg');
            background-size: cover; background-position: center; z-index: 0;
        }

        /* Container que limita a largura no PC para não ficar esticado */
        .login-wrapper {
            max-width: 400px;
            margin: 0 auto;
            padding-top: 15vh; /* Empurra para o meio da tela */
        }
        ...
        @media only screen and (max-width: 768px) {
            ...
            /* Remove a limitação de largura no celular */
            .login-wrapper {
    ...
    # Layout de colunas: 65% Imagem, 35% Login
    ...
    with c2:
        # Aqui está o segredo: Envolvemos tudo numa div 'login-wrapper'
