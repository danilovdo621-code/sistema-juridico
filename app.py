...
if not st.session_state['logged_in']:
    ...
    with c_login:
        # 1. Espaçador Vertical (Empurra o login para baixo)
        # No celular empurra menos (5vh), no PC empurra mais (25vh)
        st.markdown("""
        ...
        # 2. Colunas Internas para Centralizar Horizontalmente
        # [Espaço Vazio] [FORMULÁRIO] [Espaço Vazio]
        # Isso garante que o formulário não fique esticado nem esmagado
        _, col_form, _ = st.columns([1, 4, 1])

        with col_form:
            st.markdown("<h1 style='text-align: center; color: #1e3a8a; font-family: Inter; font-size: 32px;'>⚖️ Jurídico Pro</h1>", unsafe_allow_html=True)
            st.markdown("<p style='text-align: center; color: #64748b; margin-bottom: 30px;'>Acesso ao Portal do Cliente</p>", unsafe_allow_html=True)
