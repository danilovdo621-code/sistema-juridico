...
if not st.session_state['logged_in']:
    ...
    with c_login:
        ...
        st.markdown("""
            ...
            <style>
                @media (max-width: 768px) { .desktop-spacer { height: 10vh !important; } }
            </style>
        """, unsafe_allow_html=True)
        ...
        with col_form:
            # AQUI ESTÁ A MUDANÇA: SÓ A LOGO GRANDE
            st.markdown("""
                <div style="text-align: center; font-size: 80px; margin-bottom: 20px;">
                    ⚖️
                </div>
            """, unsafe_allow_html=True)
