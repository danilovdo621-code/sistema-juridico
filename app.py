...
if not st.session_state['logged_in']:
    ...
    st.markdown("""
        ...
        @media only screen and (max-width: 768px) {
            ...
            div[data-testid="column"]:nth-of-type(2) { width: 100% !important; min-width: 100% !important; padding: 20px !important; }
            .split-bg { display: none !important; }
            .stApp { background-color: #ffffff; }
            .login-title { font-size: 1.8rem !important; margin-top: 3rem !important; }
        }
    ...
    with c2:
        # AQUI ESTÁ O TRUQUE:
        # Criei um container com largura máxima (max-width) para o PC.
        # Isso impede que o login fique "esticado" em telas grandes.
        st.markdown("""
            <style>
            @media (min-width: 769px) {
                ...
                /* Limita a largura do conteúdo dentro da coluna */
