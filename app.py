...
if not st.session_state['logged_in']:
    ...
    st.markdown("""
        ...
        /* Isso cria a caixa branca centralizada */
        ...
        div[data-testid="stTextInput"] label {
            font-family: 'Inter', sans-serif; font-size: 13px; color: #334155; font-weight: 500;
        }
        div[data-testid="stTextInput"] input { 
            border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px 15px; 
            font-family: 'Inter', sans-serif; background-color: #ffffff; color: #0f172a;
            transition: all 0.2s;
        }
        ...
        div[data-testid="stButton"] button { 
            ...
            font-size: 15px; margin-top: 15px; letter-spacing: 0.5px;
        ...
        @media only screen and (max-width: 768px) {
            ...
            .right-side-bg { width: 100% !important; background-color: #ffffff; }
    ...
    with c1: st.write("") # Imagem

    with c2:
        # Container para limitar a largura do formulário (O "Card")
        with st.container():
            st.markdown("""
                <style>
            ...
            st.markdown("""
                <div class="login-header">
                    ...
                    <div class="login-title">Jurídico Pro</div>
                    <div class="login-subtitle">Bem-vindo ao seu portal</div>
                </div>
            """, unsafe_allow_html=True)

            email = st.text_input("E-mail", placeholder="ex: nome@email.com")
            ...
            st.markdown("<div style='text-align: center; color: #cbd5e1; font-size: 11px; margin-top: 30px;'>Ambiente Seguro SSL</div>", unsafe_allow_html=True)
